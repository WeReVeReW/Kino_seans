...
public class fullFilmsData {
    ...
    public  fullFilmsData(Integer id,String kinoteatr_name, String film_name, String film_director, String film_operator, String film_actors, String film_style, String film_studio){
